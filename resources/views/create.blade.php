...
<div class="content">
    <div class="main">
        <form action="post" method="post" enctype='multipart/form-data'>
            ...
            <div class = "card details large">
                ...
                <button class type="upload" disabled>Upload Image</button>
    ...
    <div class="side">
        <div class ="card">
            <p class="em sm"><b>Before you post:</b></p>
            ...
            <p class="nm sm tagline"><b>ramble on.</b></p>
            <hr>
            <textarea class="nm sm guidelines" id="controlx" readonly>
            ...
            <button onclick="toggleVisibility()">Show Guidelines</button>
        </div>
    </div>
</div>

<script type="text/javascript">
    var isGuidelineExtended = false;
    function toggleVisibility() {
        var control = document.getElementById("controlx");
        console.log("test");
        isGuidelineExtended? control.classList.add('extend') : control.classList.remove('extend');
        
        if (isGuidelineExtended) {
            control.style.height = "5.6875rem";
        } else {
        ...
        isGuidelineExtended = !isGuidelineExtended;
    }
</script>
